...
// Auswahl von nur den fünf Waldklassen
var classesToDisplay = [1, 2, 3, 4, 5];

// Maske weöche nur die fünf Waldklassen enthält
...
Map.addLayer(maskedLandCover, {
  min: 1,
  max: 5,
  palette: ['05450a', '086a10', '54a708', '78d203', '009900'] // Farben von https://developers.google.com/earth-engine/datasets/catalog/MODIS_061_MCD12Q1#bands
}, 'All mayor Forest Classes');


// Exportieren des GeoTiffs nach Drive
Export.image.toDrive({
  image: maskedLandCover,
  description: 'forest_cover_export_world',  // Name der Datei
